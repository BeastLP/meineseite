...
<head>
    ...
    <meta charset="utf-8">
    <title><?= $site_name ?> - Dark-Network</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Impressum - Dark-Network">
    <style>
    ...
    <link href="https://dark-network.eu/assets/css/theme.min.css" rel="stylesheet" type="text/css" media="all" />
    <link rel="preload" as="font" href="https://dark-network.eu/assets/fonts/Inter-UI-upright.var.woff2" type="font/woff2" crossorigin="anonymous">
    <link rel="preload" as="font" href="https://dark-network.eu/assets/fonts/Inter-UI.var.woff2" type="font/woff2" crossorigin="anonymous">
  </head>
